...
public class BusWaitTimeAtStopList
{
   BusWaitTimeAtStop[] list;

   transient IntIntHashMap<BusWaitTimeAtStop> cache = null;

   public BusWaitTimeAtStop findBusWaitTimeAtStop(int FRT_FID, int ORT_NR)
   {
      if (cache == null)
      {
         cache = new IntIntHashMap<BusWaitTimeAtStop>();
         for (BusWaitTimeAtStop time: list)
         {
